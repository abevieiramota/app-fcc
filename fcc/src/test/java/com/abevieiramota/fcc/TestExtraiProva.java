...
public class TestExtraiProva {
	...
	public static void beforeClass() throws IOException {
		...
		String filepathTRE2015AP = TestExtraiProva.class.getClassLoader()
				.getResource("prova/2015-tre-ap-analista-judiciario-analise-de-sistemas.pdf").getFile();

		ExtraiProva ep = new ExtraiProva();

		questoesTRE2015AP = ep.extraiQuestoes(new File(filepathTRE2015AP));

		String filePathTRT2016ROAC = TestExtraiProva.class.getClassLoader()
				.getResource("prova/2016-trt-14-regiao-ro-e-ac-analista-judiciario-tecnologia-da-informacao.pdf").getFile();

		questoesTRT2016ROAC = ep.extraiQuestoes(new File(filePathTRT2016ROAC));
	...
	public void testQuestao10() {
		...
		Questao questao1 = questoesTRT2016ROAC.get(9);
